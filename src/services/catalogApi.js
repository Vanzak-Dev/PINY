...
export const catalogApi = {
  ...
  listCollectionsAdmin: () => request('/api/admin/collections'),
  createCollection: (data) => request('/api/admin/collections', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(data) }),
  updateCollection: (id, data) => request(`/api/admin/collections/${encodeURIComponent(id)}`, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(data) }),
  removeCollection: (id) => request(`/api/admin/collections/${encodeURIComponent(id)}`, { method: 'DELETE' }),
